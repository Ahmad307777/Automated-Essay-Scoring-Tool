...
git clone https://github.com/YOUR_USERNAME/essay-scoring.git
cd essay-scoring
...
@misc{essay_scoring_2026,
  ...
  year={2026},
  publisher={GitHub},
  url={https://github.com/YOUR_USERNAME/essay-scoring}
}
```

## 📝 Documentation

- [Project Explanation](PROJECT_EXPLAINED.md) - Detailed system walkthrough
- [Assignment Reports](Assignment3_Implementation_Report.docx) - Technical documentation
- [LaTeX Source](Assignment3_Complete_Overleaf.tex) - Academic report
...
- Ahmad Mustafa - [GitHub](https://github.com/YOUR_USERNAME)
- Aqeel Abbas Khan - [GitHub](https://github.com/YOUR_USERNAME)
